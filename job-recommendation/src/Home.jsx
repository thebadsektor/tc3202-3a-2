    ...
    <div className="flex flex-col min-h-screen w-full">
      ...
      <header className="bg-white text-gray-800 py-4 px-6 shadow-sm w-full">
        <div className="container mx-auto w-full">
          ...
          <nav className="hidden md:flex space-x-14 place-items-end">
            ...
            <div className="flex space-x-10">
              <button 
                ...
                className="bg-blue-500 text-white px-5 py-2 rounded-full font-semibold hover:bg-blue-600 transition-colors tracking-wider"
              >
                Sign Up
              </button>
              <button 
                onClick={handleLogin}
                className="bg-white text-blue-500 px-5 py-2 rounded-full font-semibold border border-gray-200 hover:bg-gray-100 transition-colors tracking-wider"
              >
                Log In
              </button>
            </div>
        ...
        <div className="container mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start max-w-4xl mx-auto relative">
            ...
            <div className="flex flex-col items-center w-full md:w-1/4 relative">
              ...
              <h3 className="text-xl font-semibold mt-2 text-blue-500 text-center">Browse Result</h3>
              <p className="text-gray-600 text-center mt-2">
