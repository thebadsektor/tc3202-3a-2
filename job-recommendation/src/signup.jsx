    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (user) {
                ...
                alert("Sign-up successful! A verification link has been sent to your email.");
            ...
            <div className="w-full max-w-md bg-white p-10 rounded-lg shadow-md relative">
                ...
                <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center"> 
                        ...
                        className="mr-2" /> <label htmlFor="terms" 
                        className="text-sm text-gray-600"> By signing up, you agree to the{" "} 
